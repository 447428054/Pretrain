...
def get_raw_instance(document,max_sequence_length): # 新增的方法
    ...
    if len(curr_seq)>max_sequence_length_allowed/10: # /2
        result_list.append(curr_seq)
...
def create_masked_lm_predictions(tokens, masked_lm_prob,
    ...
    output_tokens = [t[2:] if len(re.findall('##[\u4E00-\u9FA5]', t))>0 else t for t in tokens] # 去除## 得到真实的输出token
...
if __name__ == "__main__":
    ...
    # FLAGS.input_file = './raw_text/lcqmc4pretrain.txt'
    # FLAGS.output_file = './tf_records_all/tf_lcqmc.tfrecord'
    # FLAGS.vocab_file = './resources/vocab.txt'
    tf.app.run()