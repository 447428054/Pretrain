...
flags.DEFINE_integer("max_predictions_per_seq", 51,
...
if __name__ == "__main__":
  ...
  FLAGS.input_file = './data/lcqmc4pretrain.txt'
  FLAGS.output_file = './data/tf_lcqmc_test.tfrecord'
  FLAGS.vocab_file = './albert_config/vocab.txt'
  tf.app.run()