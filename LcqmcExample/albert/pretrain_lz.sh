...
export BERT_BASE_DIR=/home/root1/lizheng/pretrainModels/tensorflow/chinese/albert_small_zh_google
python3 run_pretraining_google.py --input_file=./data/tf_lcqmc.tfrecord --eval_batch_size=64 \
--output_dir=./savealbert --do_train=True --do_eval=True --albert_config_file=$BERT_BASE_DIR/albert_config_small_google.json  --export_dir=./export_albert \
