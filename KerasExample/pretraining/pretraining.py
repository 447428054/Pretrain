...
model_saved_path = '../savepretrain/bert_model.ckpt'
corpus_paths = [
...
checkpoint_path = '/home/root1/lizheng/pretrainModels/tensorflow/chinese/chinese-bert_chinese_wwm_L-12_H-768_A-12/bert_model.ckpt'  # 如果从零训练，就设为None
