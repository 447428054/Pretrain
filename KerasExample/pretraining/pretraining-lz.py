...
model_saved_dir = '../save_pretrain/savepretrain-unlabelaug-traintestAB-nezha-base-ngram-epo21/'
corpus_paths = [
    '../corpus_pretrain/corpus_tfrecord-traintestAB-ngram-nezha-base-time20/corpus.%s.tfrecord' % i for i in range(10)
]
...
config_path = '/home/ytkj/root1/lizheng/2022Match/save_pretrain/transpretrain-unlabel-nezha-rawbase-ngram-epo26/bert_config.json'
checkpoint_path = '/home/ytkj/root1/lizheng/2022Match/save_pretrain/unlabelaug_time20/transpretrain-nezha-base-ngram-epo20/bert_model.ckpt'  # 如果从零训练，就设为None
learning_rate = 0.00176
weight_decay_rate = 0.01
num_warmup_steps = 3125
num_train_steps = 125000
steps_per_epoch = 10000
grad_accum_steps = 96  # 16大于1即表明使用梯度累积
...
def build_transformer_model_with_mlm():
    ...
    bert = build_transformer_model(
        config_path, with_mlm='linear', return_keras_model=False,model='nezha'
    )
...
class ModelCheckpoint(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        self.model.save_weights(os.path.join(model_saved_dir, 'bert_model_0.ckpt'.format(epoch)), overwrite=True)
        bert.save_weights_as_checkpoint(filename='../save_pretrain/unlabelaug_traintest_time20/transpretrain-nezha-base-ngram-epo{}/bert_model.ckpt'.format(epoch))
...
early_stopping = EarlyStopping(monitor='mlm_acc_loss', patience=2)
