...
model_saved_dir = '../save_pretrain/savepretrain-unlabeli-traintestAB-nezha-base-ngram-epo26-FGM/'
corpus_paths = [
    '../corpus_pretrain/corpus_tfrecord-traintestAB-ngram-nezha-base/corpus.%s.tfrecord' % i for i in range(10)
]
...
checkpoint_path = '/home/ytkj/root1/lizheng/2022Match/save_pretrain/transpretrain-unlabel-nezha-rawbase-ngram-epo26/bert_model.ckpt'  # 如果从零训练，就设为None
...
class ModelCheckpoint(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        self.model.save_weights(os.path.join(model_saved_dir, 'bert_model_{}.ckpt'.format(epoch)), overwrite=True)
